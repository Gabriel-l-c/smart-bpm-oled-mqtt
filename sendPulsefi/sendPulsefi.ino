//-------------------------------------------------------------
// FREQ + SENSOR+ MICRO+ NAO MENOR QUE 58 BPM COM MQTT PUBLISHER
/*
  Monitor de Frequência Cardíaca (MAX30105) - Versão Não-Bloqueante com MQTT
...
{
  Serial.begin(115200);
  Serial.println("Heart Rate Monitor (MQTT Sender) Initializing...");
  ...
  // 3. Inicialização do Pino do LED
  pinMode(LED_PIN, OUTPUT);
  
  // 4. Inicialização do Sensor
